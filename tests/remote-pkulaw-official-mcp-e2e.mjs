...
console.log(JSON.stringify({ok:true,classification:"PKULAW_OFFICIAL_MCP_E2E_PASS",service:"mcp-law",tool_count:x.j.result.tool_count,protocol_version:x.j.result.protocol_version||null,legacy_secret_alias_used:Boolean(x.j.result.legacy_secret_alias_used),base}));
