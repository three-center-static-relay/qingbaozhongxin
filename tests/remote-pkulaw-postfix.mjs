...
console.log(JSON.stringify({ok:true,provider,operation:"page_info",auth_mode:x.j.result.auth_mode,persistent_context_configured:x.j.result.persistent_context_configured,classification:"PRODUCTION_E2E_PASS",probe_rev:PROBE_REV,base}));
