...
console.log(JSON.stringify({ok:true,suite:"diag-policy-static",federal_register:OPERATIONS.federal_register,congress_gov:OPERATIONS.congress_gov,regulations_gov:OPERATIONS.regulations_gov}));
