...
try{
  ...
  globalThis.fetch=async (url,init={})=>{
    ...
    if(u.hostname==="planetarycomputer.microsoft.com")return new Response(JSON.stringify({collections:[{id:"sentinel-2-l2a"}]}),{status:200,headers:{"content-type":"application/json"}});
    if(u.hostname==="stac.dataspace.copernicus.eu")return new Response(JSON.stringify({collections:[{id:"sentinel-2-l2a"}]}),{status:200,headers:{"content-type":"application/json"}});
