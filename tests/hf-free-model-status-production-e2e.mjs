...
try{
  ...
  console.log(JSON.stringify({ok:true,stage:"production-envelope",http_status:response.status,provider:body.provider,operation:body.operation,result_keys:Object.keys(body.result),result_digest:body.result_digest??null,secrets_redacted:true}));
