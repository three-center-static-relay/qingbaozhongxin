...
for(const tool of ["common_crawl","scrapy","playwright","warcio","selectolax"])assert.ok(manifest.added_tools[tool]);
...
console.log(JSON.stringify({ok:true,suite:"network-intelligence-hardening",common_crawl:true,mainland_government_public_collection_priority:true,no_evasion:true,inference_labels:manifest.evidence_contract.inference_labels}));
