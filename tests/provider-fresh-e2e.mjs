...
const network=setupServer(
  ...
  http.post("https://mcp.wind.com.cn/vserver_stock_data/mcp/",async({request})=>{
    ...
    if(b.method==="tools/list")return j({jsonrpc:"2.0",id:b.id,result:{tools:[{name:"get_stock_price_indicators",description:"stock price indicators",inputSchema:{type:"object",properties:{windcode:{type:"string"}},required:["windcode"]}},{name:"get_stock_quote",inputSchema:{type:"object"}}]}});
