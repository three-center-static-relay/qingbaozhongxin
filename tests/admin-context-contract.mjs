...
// The production Worker now uses a fusion wrapper, which must preserve the existing browser/admin chain.
assert.match(wrangler,/"main"\s*:\s*"src\/intelligence-fusion-entry\.js"/);
...
console.log(JSON.stringify({
  ...
  situational_fusion_wrapper:true,
  ai_advisory_automatic:false,
  auto_paid_budget_usd:0,
