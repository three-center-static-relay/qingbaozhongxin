...
try{
  ...
  console.log(JSON.stringify({ok:true,suite:"copernicus-cdse-stac",public_catalog:true,operations:6,sentinel_item:true,asset_refs:true,openeo_handoff:true,binary_proxy:false,guards:["fixed-CDSE-host","safe-ids","bounded-bbox","bounded-results","no-binary-proxy"]}));
