...
async function modelScopeRuntimeSelftest(env){
  ...
  return json({
    ...
    models_nonempty:p.models_nonempty===true,
    models_payload_bytes:p.models_payload_bytes??0,
    models_payload_digest:p.models_payload_digest||null,
    datasets_ok:p.datasets_ok===true,
    datasets_count:p.datasets_count??0,
    datasets_nonempty:p.datasets_nonempty===true,
    datasets_payload_bytes:p.datasets_payload_bytes??0,
    datasets_payload_digest:p.datasets_payload_digest||null,
    skills_ok:p.skills_ok===true,
    skills_count:p.skills_count??0,
    skills_nonempty:p.skills_nonempty===true,
    studios_ok:p.studios_ok===true,
    studios_count:p.studios_count??0,
    studios_nonempty:p.studios_nonempty===true,
