...
export const CATALOG_VERSION="2026-08-15.25";
...
export const CATALOG={
  ...
  dlr_wsf:{category:"open-global-settlement-evolution-built-form",access:"public",adapter:"open_location.dlr-stac",integration:"official-dlr-eoc-stac+wms+downloads",scope:"settlement-mask-2019-settlement-evolution-1985-2015-built-form-crosscheck",endpoint:"https://geoservice.dlr.de/eoc/ogc/stac/v1",license_note:"WSF 2019 and WSF Evolution are CC-BY-4.0; verify dataset-specific terms for other WSF products",arbitrary_url:false},
  nasa_cmr:{category:"nasa-earthdata-discovery",access:"public",adapter:"nasa.cmr-search",integration:"official-cmr-search",scope:"collections-granules-variables-services+high-value-presets:merra2,gpm-imerg,smap,ecostress,gedi,swot,grace-fo,tempo,sedac,black-marble,modis,viirs,landsat",endpoint:"https://cmr.earthdata.nasa.gov/search",billing:"public-free",arbitrary_url:false},
