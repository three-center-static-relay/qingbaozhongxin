...
export const CATALOG={
  ...
  libris:{category:"national-library-union-catalog-sweden",access:"public",adapter:"libris.search",integration:"official-libris-xl-find-api",scope:"swedish-national-bibliography-and-union-catalog-linked-data",endpoint:"https://libris.kb.se/find.jsonld",terms:"public-read-apis;swedish-national-bibliography-and-authority-data-cc0"},
  bne_lod:{category:"national-library-linked-open-data-spain",access:"public",adapter:"catalog-only",integration:"official-sparql+content-negotiation+bulk-rdf",scope:"bibliographic-authority-subject-linked-data",endpoint:"https://datos.bne.es/sparql",terms:"cc0"},
  archives_portal_europe:{category:"archive-aggregator-europe",access:"key",secrets:["ARCHIVES_PORTAL_EUROPE_API_KEY"],adapter:"catalog-only",integration:"official-api",scope:"archival-descriptions-record-creators-institutions-europe",registration_url:"https://www.archivesportaleurope.net/",note:"create-a-free-account-and-obtain-a-free-api-key;reuse-rights-vary-by-contributing-institution"},
  openml:{category:"machine-learning-dataset-task-knowledge",access:"public",adapter:"catalog-only",integration:"official-rest",scope:"datasets-tasks-runs-flows-studies",endpoint:"https://www.openml.org/api/v1/json/"},
  eurlex_cellar:{category:"legal-publications-eu",access:"public",adapter:"catalog-only",integration:"official-cellar-rest+sparql",scope:"eu-law-eu-publications-metadata-content",endpoint:"https://publications.europa.eu/webapi/rdf/sparql",note:"EUR-Lex search webservice also free after registration; Cellar metadata/content interfaces are the preferred bulk-safe machine interfaces"},
  uk_legislation:{category:"legal-official-uk",access:"public",adapter:"catalog-only",integration:"official-api+atom+machine-readable-formats",scope:"uk-primary-secondary-and-retained-eu-legislation",endpoint:"https://www.legislation.gov.uk/",terms:"open-government-licence-v3-except-where-stated"},
