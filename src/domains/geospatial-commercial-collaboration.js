export const GEOSPATIAL_NETWORK_COLLAB_VERSION="geospatial-network-collab-v1.1-20260817";
...
export async function runAdapter(provider,operation,args={}){
  ...
  const geo=[province,city].filter(Boolean).join(" "),aliases=[place,"福州宝龙广场","宝龙城市广场","宝龙广场","福州台江宝龙广场"].filter((x,i,a)=>x&&a.indexOf(x)===i),web=[
  ...
  return{provider,operation,version:GEOSPATIAL_NETWORK_COLLAB_VERSION,mode:"serial-controller-plan",collaboration:{network_intelligence_branch:"network-intelligence-collection",geospatial_branch:"geospatial-commercial",compute_center:"compute-center",controller_contract:"serial-v1",fanout_inside_worker:false,compute_handoff:true},place:{name:place,city,province:province||null,country_code:country,municipality,location:p.s,aliases},plan:[
    ...
    {stage:4,provider:"tencent_maps",operation:"place_nearby",args:{keyword:"公交站",location:p.s,radius:1000,limit:20},required:false,evidence_kind:"observed-map-poi"},
    {stage:5,provider:"baidu_maps",operation:"traffic_around",args:{center:p.s,radius:500,coord_type_input:"wgs84",coord_type_output:"bd09ll"},required:false,acceptance_note:"provider readiness verified; Baolong live traffic business call remains unresolved",evidence_kind:"observed-road-traffic"},
    {stage:6,provider:"geonames",operation:"nearby",args:{lat:p.lat,lng:p.lng,radius:10,limit:20,lang:"zh"},required:true,evidence_kind:"reference-place-admin"},
    {stage:7,provider:"mobilitydatabase",operation:"gtfs_search",args:{country_code:country,municipality,limit:20},required:true,evidence_kind:"transit-feed-metadata"},
    {stage:8,provider:"network-intelligence-collection",operation:"bounded_search",args:{preferred_providers:["tavily","exa","firecrawl"],queries:web,results_per_query:3,country:"CN"},required:true,evidence_kind:"public-web-proxy"},
    {stage:9,provider:"compute-center",operation:"feature_fusion",args:{models:["location_intelligence.commercial_spatial_fusion","location_intelligence.site_ranking","location_intelligence.white_space","location_intelligence.competitor_diversion","location_intelligence.synthetic_od_gravity","location_intelligence.trade_area_huff","location_intelligence.footfall_proxy_nowcast","location_intelligence.dwell_proxy_nowcast"],deferred_transforms:["h3","population-area-aggregation","bulk-poi-building-raster-features"]},required:true,evidence_kind:"modeled"}
  ],acceptance_profile:{required:["geonames","mobilitydatabase","network-intelligence-collection","compute-center"],optional:["tencent_maps","baidu_maps"],reason:"ordinary map POI/traffic enrichments improve decision support but do not close observed-person-LBS parity"},observed_mobile_lbs:false,real_footfall:false,dwell_time_observed:false,origin_destination_observed:false,cross_mall_audience_overlap_observed:false,payment_spend_observed:false,execution_policy:{serial:true,max_retries:0,arbitrary_url:false,network_search_is_proxy_only:true,compute_network:false,fail_closed:true},limitations:["map-poi-and-road-traffic-do-not-equal-person-footfall","public-web-signals-are-proxy-only","no-observed-phone-footfall","no-observed-dwell-time","no-observed-mobile-od","no-cross-mall-audience-overlap","no-private-consumer-profile-or-payment-spend"]};
}
