...
export const NETWORK_INTELLIGENCE_HARDENING=Object.freeze({
  ...
  added_tools:{
    ...
    cloudflare_browser_run:{role:"javascript-rendered-public-page-collector",execution:"cloudflare-browser-binding-quick-action-content",access:"workers-binding-no-api-token",production_status:"real-e2e-verified-browser-runtime",runtime_e2e_receipt:"docs/browser-run-cn-e2e-20260817.md",runtime_e2e_scope:"BROWSER binding + content Quick Action against fixed public mainland-China target; not every adapter/site individually E2E-verified",automatic_fallback:false,arbitrary_target_fetch:false,notes:"Sole browser runtime for network-intelligence. Use only fixed allowlisted public-source URLs when static fetch is insufficient; preserve X-Browser-Ms-Used for usage accounting."},
